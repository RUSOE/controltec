...
public class DialogoConfirmar {
    ...
    public DialogoConfirmar(final Context c, final Practica practica) {
        ...
        String titulo = "Solicitud para realizar " + practica.getTitle() + " : "+ practica.getTipo();

        mAlumno = new Alumno("Jose","IngMecatronica",15400806,7,"joalaguiarar@ittpic.edu.mx");

        final String body = "Solicitud de ingreso a laboratorio para realizar la practica "+practica.getTitle()+" de la seccion "+practica.getTipo();
